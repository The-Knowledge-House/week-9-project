...
/**
  ...
  b. add a class to the element
  c. append the element to the body ) 
 */
 ...
 */
  ...
  // setInterval(() => { 
  //   duckDiv.hasAttribute("class", "flap") ?
  //   duckDiv.classList.remove("class", "flap") :
  //   duckDiv.classList.add("class", "flap")
  // }, 250);
